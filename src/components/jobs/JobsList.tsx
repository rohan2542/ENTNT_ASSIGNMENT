...
//         <button
//           onClick={handleCreate}
//           className="bg-slate-900 hover:bg-slate-800 text-white rounded-full shadow-lg px-5 py-2"
//         >
//           + Create Job
//         </button>
//       </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <main className="md:col-span-3">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              onClick={handleCreate}
              className="bg-slate-900 hover:bg-slate-800 text-white rounded-full shadow px-5 py-2"
            >
              + Create Job
            </button>
          </div>
